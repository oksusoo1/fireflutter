...
describe("Post list test", () => {
  ...
  it("test listing option", async () => {
    ...
    expect("author" in re[0] === true).true;
    expect("authorLevel" in re[0] === true).true;
    expect("authorPhotoUrl" in re[0] === true).true;
    ...
    expect("author" in re[0] === false).true;
    expect("authorLevel" in re[0] === false).true;
    expect("authorPhotoUrl" in re[0] === false).true;
  });
});
