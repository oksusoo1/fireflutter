...
- Then, it will pick the image, and compress
- Then, upload image
  - And thumbnail image will be generated by cloud function.
- Then, ues `StorageImage` widget to display the image.
  - What `StorageImage` does;
    - it will show ...
