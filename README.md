...
- `CustomTest` helper class does some basic scaffolding to test screen and access the input and submit.
  - You can test the fireflutter widgets like post creation form or comment creation form.

- For error test, the test should catch the error, so it will not to break the code flow by throwing an exception.
